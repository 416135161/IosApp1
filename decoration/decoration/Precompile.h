...
#undef	BLOCK_OBJC
#define BLOCK_OBJC(objc,__objc)     __block typeof(objc) __objc = objc
...
//网络图片适配高度
#define kMatchHeight(w,h,Width) (Width) * (h) / (w)
...
#define GlobalGrayColor  [UIColor globalGrayColor]
#define GlobalTintColor  [UIColor globalTintColor]
#define GlobalRedColor  [UIColor globalRedColor]
#define ColorWithString(COLOR) [UIColor colorWithString: COLOR];
